...
class AdministratorDashboardArticle extends Component {
                ...
                <Modal size="lg" centered show={this.state.addModal.visible}
                    ...
                    <Form.Group>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="add-description" as="textarea" rows={10} value={this.state.addModal.description}
                ...
                <Modal size="lg" centered show={this.state.editModal.visible}
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="edit-description" as="textarea" rows={10} value={this.state.editModal.description}
